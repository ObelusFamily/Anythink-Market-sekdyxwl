...
Route::get('drama', function (Request $request) {
    ...
    $mdb_collection = DB::connection('mongodb')->collection('reels');

    // Use the where method to filter documents and then count them
    $mdb_bsondoc = $mdb_collection->where($mongodbquery)->count();
